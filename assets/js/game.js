...
var fight = function () {
    ...
    //if the player coses to fight, then fight

    if (promptFight === "fight" || promptFight === "fight") {// remove enemy's health by subtracting the amount set in the the playerAttack var
        ...
        if (confirmSkip) {
            window.alert(playName + " has decided to skip this fight. Goodbye!");
